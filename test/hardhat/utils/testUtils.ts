import { AbiCoder, AddressLike, BigNumberish, Contract, Interface, dataSlice, parseEther, toBeHex } from 'ethers';
...
export async function fund (contractOrAddress: string | Contract, amountEth = '1'): Promise<void> {
        ...
        await firstSigner.sendTransaction({ to: address, value: parseEther(amountEth) })
}
